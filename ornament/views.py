...
class OrnamentListView(ListView):
    ...
    def get_queryset(self):
        ...
        ornament_type = self.request.GET.get("ornament_type", Ornament.OrnamentCategory.STOCK)
        metal_type = self.request.GET.get("metal_type")
    ...
    def get_context_data(self, **kwargs):
        ...
        context['ornament_type'] = self.request.GET.get('ornament_type', Ornament.OrnamentCategory.STOCK)
