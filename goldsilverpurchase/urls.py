...
from .views import (
    ...
    performance_report, track_home_performance,
    export_full_db_dump, import_full_db_dump,
...
urlpatterns = [
    ...
    path('performance-report/', performance_report, name='performance_report'),
    path('performance-report/track-home/', track_home_performance, name='track_home_performance'),
    ...
    path('export-full-db-dump/', export_full_db_dump, name='export_full_db_dump'),
    path('import-full-db-dump/', import_full_db_dump, name='import_full_db_dump'),
